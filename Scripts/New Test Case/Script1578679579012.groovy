...
WebUI.click(findTestObject('Object Repository/Page_A simple AJAX website with jQuery/a_Page 3'))

WebUI.click(findTestObject('Object Repository/Page_A simple AJAX website with jQuery/a_Page 4'))
